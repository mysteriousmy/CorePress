...
const langs = import.meta.glob("~/i18n/*/index.json", {
  eager: true,
  import: "lang",
})
...
const defaultLang =
  languages.find(
    (lang) =>
      lang.code.toLocaleLowerCase() === navigator.language.toLocaleLowerCase()
  )?.code ||
  languages.find(
    (lang) =>
...
const imports = import.meta.glob("~/i18n/entry.ts")
